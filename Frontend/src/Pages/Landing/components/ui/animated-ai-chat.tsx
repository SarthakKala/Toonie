...
export function AnimatedAIChat() {
    ...
    return (
        <div className="min-h-screen flex flex-col w-full items-center justify-center bg-transparent text-white p-6 relative overflow-hidden ai-chat-hide-cursor">
            ...
            <div className="w-full max-w-2xl mx-auto relative">
                ...
                >
                    <div className="text-center space-y-3">
                        ...
                        >
                            Turn your ideas into animated scenes with AI.
                        </motion.p>
                    </div>
                    ...
                    >
                        ...
                        <div className="p-4">
                            <Textarea
                                ...
                                placeholder="What would you like to animate..."
