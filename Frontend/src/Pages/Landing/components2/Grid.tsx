    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            {/* Screen */}
            <rect x="5" y="1" width="32" height="22" rx="3" stroke="rgba(255,255,255,0.35)" strokeWidth="1.5" />
            {/* Screen inner bezel */}
            <rect x="8" y="4" width="26" height="16" rx="1.5" stroke="rgba(255,255,255,0.15)" strokeWidth="1" />
            {/* Prompt lines on screen */}
            <line x1="11" y1="9"  x2="22" y2="9"  stroke="rgba(255,255,255,0.22)" strokeWidth="1.2" strokeLinecap="round" />
            <line x1="11" y1="13" x2="18" y2="13" stroke="rgba(255,255,255,0.14)" strokeWidth="1.2" strokeLinecap="round" />
            {/* Cursor blink */}
            <rect x="19" y="11.5" width="1.2" height="3" rx="0.6" fill="rgba(255,255,255,0.45)" />
            {/* Hinge */}
            <line x1="5" y1="23" x2="37" y2="23" stroke="rgba(255,255,255,0.2)" strokeWidth="1" />
            {/* Base */}
            <path d="M1 24 Q1 27 5 27 L37 27 Q41 27 41 24 Z" stroke="rgba(255,255,255,0.3)" strokeWidth="1.5" fill="none" />
            {/* Trackpad */}
            <rect x="16" y="24.5" width="10" height="1.5" rx="0.75" fill="rgba(255,255,255,0.15)" />
          </svg>
      ...
      >
        ...
        <div>
          ...
          <p style={{ color: "rgba(255,255,255,0.35)", fontSize: "0.78rem" }}>
            SarthakKala / Toonie — star the repo ↗
          </p>
        </div>
      </a>
    </div>
